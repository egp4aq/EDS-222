...
2.  What does the intercept tell you, in words?
    ...
    The mpg of a size zero engine in year 1999. (35.792)

3.  What does the coefficient on `displ` tell you, in words?

    The coefficient on displ is the slope (beta hat 1) –\> the slope of the reference line
...
ggplot(mpg, aes(x = displ, y = hwy, color = year)) +
  geom_point() +
  #geom_line(data = mod3, aes(y = .fitted, color = year)) + 
  #(x2=0 or year = 1999)
